...
public abstract class CovidUMLSCollectionDocument implements SourceDocument {
    private static final Logger LOG = LogManager.getLogger(CovidUMLSCollectionDocument.class);
    protected String id;
    ...
    public void putField(String name, String content) {
